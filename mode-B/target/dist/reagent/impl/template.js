...
var G__12721 = o;
(G__12721[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12723__i < G__12723__a.length) {G__12723__a[G__12723__i] = arguments[G__12723__i + 0]; ++G__12723__i;}
...
var G__12725 = o;
(G__12725[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__12730 = props;
var G__12730__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12730,cljs.core.cst$kw$id,id):G__12730);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12730__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12731){
...
var props = map__12732__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12732__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12734){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12735__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12735,map__12735__$1,on_write){
return (function (){
...
});})(node_value,map__12735,map__12735__$1,on_write))
);
} else {
...
var G__12738 = jsprops;
(G__12738["defaultValue"] = value);

(G__12738["onChange"] = ((function (G__12738,v,value,on_change){
return (function (p1__12737_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12737_SHARP_);
});})(G__12738,v,value,on_change))
);
...
var vec__12741 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12741,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12741,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12741,(2),null);
...
var temp__5827__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__5827__auto__ == null)){
...
var jsprops = ({"argv": v});
var temp__5829__auto___12745 = reagent.impl.template.key_from_vec(v);
if((temp__5829__auto___12745 == null)){
} else {
var key_12746 = temp__5829__auto___12745;
(jsprops["key"] = key_12746);
}
...
var temp__5829__auto___12747 = reagent.impl.template.key_from_vec(argv);
if((temp__5829__auto___12747 == null)){
} else {
var key_12748 = temp__5829__auto___12747;
reagent.impl.template.oset(jsprops,"key",key_12748);
}
...
var G__12749 = reagent.impl.template.__GT_NativeWrapper();
(G__12749["name"] = c);
...
var G__12750 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12750) : reagent.impl.template.as_element.call(null,G__12750));
} else {
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12755,seq12754__$1);
});
...
break;
default:
var G__12761 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12761;
continue;
...
var n__4607__auto___12763 = a.length;
var i_12764 = (0);
while(true){
if((i_12764 < n__4607__auto___12763)){
(a[i_12764] = reagent.impl.template.as_element((a[i_12764])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___12766 = a.length;
var i_12767 = (0);
while(true){
if((i_12767 < n__4607__auto___12766)){
var val_12768 = (a[i_12767]);
if(((cljs.core.vector_QMARK_(val_12768)) && ((reagent.impl.template.key_from_vec(val_12768) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12767] = reagent.impl.template.as_element(val_12768));
...
var ctx = ({});
var vec__12770 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12770,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12770,(1),null);
...
var G__12773 = (cljs.core.count(argv) - first_child);
switch (G__12773) {
case (0):
...
case (1):
var G__12774 = comp;
var G__12775 = jsprops;
var G__12776 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12774,G__12775,G__12776) : reagent.impl.template.global$module$react.createElement.call(null,G__12774,G__12775,G__12776));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12773){
